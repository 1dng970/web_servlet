...
<ul>
    <li>공지사항 제목</li>
    <li>
        <input type="text" id="subject" name="subject" class="notice_input1"> ※ 최대 150자까지 입력이 가능
    </li>
</ul>
<ul>
    <li>글쓴이</li>
    <li>
        <input type="text" name="writer" class="notice_input2" readonly> ※ 관리자 이름이 노출 됩니다.       
    </li>
</ul>
<ul>
    <li>첨부파일</li>
...
<ul class="ul_height">
    <li>공지내용</li>
    <li>
        <textarea class="notice_input3" id="editor" placeholder="공지내용을 입력하세요!"></textarea>
    </li>
</ul>
</div>
...
<div class="board_btn">
    ...
    <button class="border_add" value="공지등록" onclick="writeok()">공지등록</button>
</div>
</form>
</section>
